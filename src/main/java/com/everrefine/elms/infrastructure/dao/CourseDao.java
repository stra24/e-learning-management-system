...
public interface CourseDao extends CrudRepository<Course, UUID> {
  ...
  @Query("SELECT * FROM courses ORDER BY course_order ASC LIMIT :pageSize OFFSET :offset")
  List<Course> findCoursesWithPagination(@Param("pageSize") int pageSize, @Param("offset") int offset);
