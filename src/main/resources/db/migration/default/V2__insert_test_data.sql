...
VALUES
('kanri@test.com', '$2a$08$1ActTrb5pvrY.LX2onroGu7ewYWMTHffGXs1h3oLh4Ho.l/LgrbZe', '管理者太郎', 'kanri123', '/uploads/kanrisya.png', 'ADMIN', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO public.users 
(email_address, "password", real_name, user_name, thumbnail_url, user_role, created_at, updated_at) 
VALUES
('ippan@test.com', '$2a$08$1ActTrb5pvrY.LX2onroGu7ewYWMTHffGXs1h3oLh4Ho.l/LgrbZe', '一般次郎', 'ippan123', '/uploads/ippan.png', 'GENERAL', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
